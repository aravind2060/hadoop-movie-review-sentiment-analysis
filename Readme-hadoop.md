...
```bash
hadoop fs -put movie_reviews.csv /input/dataset/
...
```bash
hadoop jar <your-jar-file>.jar com.sentimentanalysis.hadoop.SentimentAnalysis /input/dataset/movie_reviews.csv /output
```
